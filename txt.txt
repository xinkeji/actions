...
"Image updated successfully" = "Đã cập nhật hình ảnh thành công";
...
"Default Playback Speed" = "Tốc độ phát mặc định";
"Auto" = "Tự động";
...
"Hide Cast Button" = "Ẩn Nút truyền";
"Hide Notification Button" = "Ẩn Nút thông báo";
"Ask Befor Casting" = "Hỏi trước khi truyền";
"Confirm Casting" = "Xác nhận truyền";
"Are you sure you want to start casting?" = "Bạn có chắc chắn muốn bắt đầu truyền không?";
"Yes" = "Có";
"No" = "Không";
"Hide Shorts Cells" = "Ẩn các ô Shorts";
"Disable Startup To Shorts" = "Tắt tính năng khởi đông tiếp tục Shorts";
...
"Disable Double Tap To Seek" = "Tắt tính năng Nhấn đúp để tìm kiếm thời gian";
...
"Coded with ❤️ by MiRO\nCopyright © 2024" = "Coded bằng ❤️ bởi MiRO\nBản quyền © 2024\nDịch bởi Hiệpvk";