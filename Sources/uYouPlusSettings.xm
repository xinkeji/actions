...
- (void)updateTweakSectionWithEntry:(id)entry {
    ...
    YTSettingsSectionItem *bug = [%c(YTSettingsSectionItem)
        ...
        detailTextBlock:nil
        selectBlock:^BOOL (YTSettingsCell *cell, NSUInteger arg1) {
            NSString *url = [NSString stringWithFormat:@"https://github.com/hiepvk/uYouPlus/issues/new?assignees=&labels=bug&projects=&template=bug.yaml&title=[v%@] %@", VERSION_STRING, LOC(@"ADD_TITLE")];
